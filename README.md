...
**Pay ($5 USDC / 30 days):** [nchobah.com/pay.html](https://nchobah.com/pay.html)
**Try it (1 free query, no signup):** [/try](https://nao-00.nchobah.workers.dev/try)
**App home:** [nao-00.nchobah.workers.dev](https://nao-00.nchobah.workers.dev)
...
Every Google-indexed page (astrology content, healing meditations, angel numbers) carries a 4-column revenue footer: ElevenLabs affiliate, /healing cross-link, /support tip jar (Solana/USDC/ETH/BTC), and the paid tier at [nchobah.com/pay.html](https://nchobah.com/pay.html).
...
$5 USDC on Solana. No Stripe. No KYC. No OAuth. The public pay page at [nchobah.com/pay.html](https://nchobah.com/pay.html) generates a Solana Pay URI bound to your unique ref via a memo field; the `/pricing/verify` route polls public Solana RPC for the matching tx and mints a `naop_*` token valid for 30 days.
...
$0. Zero dollars collected as of 2026-05-21. The machine is built - revenue now is a function of time + traffic, not code. If this README gave you something, the tip jar is at /support, and if you want to talk to the council for 30 days it's $5 at [nchobah.com/pay.html](https://nchobah.com/pay.html).
